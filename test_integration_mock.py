# Test script to verify frontend-backend integration with mock server
import requests
import json
import time
...
def main():
    print("Testing Docusaurus Frontend - Backend API Integration with Mock Server...")
    print("="*70)
    ...
    print(f"\n✅ All tests passed! Session ID: {updated_session_id}")
    print("✅ Frontend-backend integration is working correctly!")
    print("\nSummary of integration:")
    print("- Docusaurus frontend can connect to backend API")
    print("- Session creation works properly")
    print("- Chat functionality is operational")
    print("- Response format is compatible with frontend component")
